    ...
    <div class="main-content">
        <div class="tab__box">
            <div class="tab__items">
                ...
                <a class="tab__item " href="?status={{ \Webamooz\Payment\Models\Settlement::STATUS_SETTLED }}">تسویه های
                    واریز شده</a>
            ...
            <table class="table">
                ...
                @foreach($settlements as $settlement)
                    <tr role="row">
                        ...
                        <td><a href="{{ route('users.full_info' ,$settlement->user->id) }}" class="text-info_custom">{{ $settlement->user->name }}</a></td>
